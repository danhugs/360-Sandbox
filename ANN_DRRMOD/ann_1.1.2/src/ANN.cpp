...
ANNpointArray annAllocPts(int maxPoints, int dim)		// allocate n pts in dim
{
	ANNpointArray pa = new ANNpoint[maxPoints];			// allocate points
	ANNpoint	  p  = new ANNcoord[maxPoints*dim];		// allocate space for coords
