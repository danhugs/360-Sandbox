...
int* GetNN(float inputPoints[][3], int inputPointCount, float qPoints[][3], int qPointCount, double errorBound)
{
	int					nInputPts;
	int					nQueryPts;
...
float* GetDists() {
	return outputNNDists;
}

int FreeMem(int* arrayPtr) {
	delete[] arrayPtr;
	return 0;
}

int FreeMemFloat(float* arrayPtr) {
	delete[] arrayPtr;
	return 0;
}
