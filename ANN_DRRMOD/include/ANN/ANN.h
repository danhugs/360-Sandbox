...
extern "C" DLL_API int* GetNN(float inputData[][3], int inputPointCount, float testData[][3], int testPointCount, double errorBound);
extern "C" DLL_API float* GetDists();
extern "C" DLL_API int FreeMem(int* ptr);
extern "C" DLL_API int FreeMemFloat(float* ptr);
